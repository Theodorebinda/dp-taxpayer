        ...
        >
          ...
          <div>
            <motion.div
              ...
              className="mb-8"
            >
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-primary/50 backdrop-blur-md border border-white/30 dark:border-white/20 shadow-lg">
