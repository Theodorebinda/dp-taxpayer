...
export default function DigiPublicSignupForm() {
  ...
  return (
    <main className="w-full relative flex items-center lg:gap-5 h-screen bg-background max-lg:flex-col-reverse max-lg:h-auto max-lg:min-h-screen max-lg:overflow-y-auto">
      ...
      {/* Contenu principal */}
      <div className="w-full max-lg:min-h-screen max-lg:pt-20 max-lg:pb-5 py-5 max-lg:px-4 flex lg:items-center max-lg:items-center items-start justify-center max-lg:justify-center p-5 max-lg:bg-transparent z-10 relative">
        <div className="lg:p-10 p-5 max-lg:w-full max-lg:max-w-2xl max-lg:mx-auto lg:w-3/4 flex flex-col gap-4 rounded-xl z-10 backdrop-blur-lg bg-background/10 dark:bg-app-blue-700 lg:shadow-lg">
          {/* Mobile: Stepper */}
